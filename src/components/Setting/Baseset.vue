...
export default {
  ...
  methods: {
    ...
    linkSuccess(res, file) {
      this.sharepic = qiniu.hosturl + res.data.base_url;
    },
    linkSuccess1(res, file) {
      this.wechat_bg = qiniu.hosturl + res.data.base_url;
    },
    ...
    getconfig() {
      ...
      baseget(allParams).then(res => {
        if (res.msg === "ok") {
          ...
          this.wechat_title = res.data.wechat_title
            ? res.data.wechat_title
            : "";
          this.ins_title = res.data.ins_title ? res.data.ins_title : "";
          this.weibo_title = res.data.weibo_title ? res.data.weibo_title : "";
          this.wechat_bg = res.data.wechat_bg
            ? res.data.wechat_bg
            : "../static/images/default.png";
          this.ins_bg = res.data.ins_bg
            ? res.data.ins_bg
            : "../static/images/default.png";
