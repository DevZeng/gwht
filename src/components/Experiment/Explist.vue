  ...
  <el-row class="warp" style="padding:20px 0 0 20px;">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>实验品管理</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
        ...
        <el-form ref="nedoc" :model="nedoc" label-width="120px" :rules="rules">
          ...
          <el-form-item label="封面：" prop="cover">
            <el-upload
              ...
              accept="image/*"
            >
              <div style="width:100px;heightL:100px;border:1px dashed #ccc;border-radius:6px;">
...
import { experimentAdd } from "../../api/api";
import { experimentGet } from "../../api/api";
import { experimentSortAdd } from "../../api/api";
import { experimentDel } from "../../api/api";
  ...
  methods: {
    ...
    getlist() {
      var allParams =
        ...
        "&language=" +
        this.select;
      experimentGet(allParams).then(res => {
...
changeSort(id,val){
      ...
      // 发送到数据库里面去
      experimentSortAdd(allParams).then(res => {
        if (res.msg == "ok") {
          this.$message({
            message: "提交成功",
            type: "success"
    ...
    save() {
      if (this.nedoc.title == "") {
        ...
        experimentAdd(allParams).then(res => {
          if (res.msg === "ok") {
            this.$message({
              message: "提交成功",
              type: "success"
    ...
    submitdel() {
      ...
      experimentDel(allParams).then(res => {
        // console.log(res)
        if (res.msg === "ok") {
          this.$message({
            message: "删除成功",
