  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-title">
        <span style="font-size: 18px;color: #fff;">凝生官网后台管理</span>
      </div>
      ...
      <div class="topbar-account topbar-btn">
        ...
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner">
            <i class="iconfont menu-yonghu" style="margin-right: 10px;"></i>
            {{username}}
            <i class="iconfont icon-down" style="margin-left: 10px;"></i>
          </span>
        ...
        <el-menu default-active="0" router :collapse="collapsed" unique-opened>
          <template v-for="(item,index) in $router.options.routes" v-if="item.menuShow">
            ...
            <el-menu-item
              ...
              v-per="item.children[0].meta.permission"
            >
              <i :class="item.iconCls"></i>
