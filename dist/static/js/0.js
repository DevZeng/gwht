...
// module
exports.push([module.i, ".login-container[data-v-6838ad70]{-webkit-border-radius:5px;border-radius:5px;-moz-border-radius:5px;background-clip:padding-box;margin:160px auto;width:350px;padding:35px 35px 15px;background:#fff;border:1px solid #eaeaea;background:-ms-linear-gradient(top,#fff,#6495ed);background:-moz-linear-gradient(top,#b8c4cb,#f6f6f8);background:-webkit-gradient(linear,0 0,0 100%,from(#b8c4cb),to(#f6f6f8));background:-webkit-gradient(linear,0 0,0 100%,from(#fff),to(#6495ed));background:-webkit-linear-gradient(top,#fff,#6495ed,#fff);background:-o-linear-gradient(top,#fff,#6495ed)}.title[data-v-6838ad70]{margin:0 auto 40px;text-align:center;color:#505458}body[data-v-6838ad70],html[data-v-6838ad70]{width:100%;height:100%;margin:0;padding:0;overflow:hidden}.container[data-v-6838ad70]{width:100％;height:100%;margin:0;padding:0;background-color:#000}", ""]);
...
var update = __webpack_require__(308)("2e1cb2c8", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(308)("524c2354", content, true);
